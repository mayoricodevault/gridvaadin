...
import com.grid.api.data.Person;
import com.grid.api.data.Persons;
import com.grid.api.form.MyForm;
import com.grid.api.renderer.BigDecimalToDoubleConverter;
import com.grid.api.renderer.BooleanTrafficLight;
...
public class GridUI extends UI {
	...
	@VaadinServletConfiguration(productionMode = false, ui = GridUI.class, widgetset="com.grid.api.MyAppWidgetset")
